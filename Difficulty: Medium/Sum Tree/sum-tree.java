...
class Solution {
    ...
    boolean isSumTree(Node root) {
        // A null tree is considered a Sum Tree
        if (root == null) {
            return true;
        }
        ...
        // Check if the current node's data is equal to the sum of left and right subtree
    ...
    // Helper method to calculate the sum of all nodes in a subtree
