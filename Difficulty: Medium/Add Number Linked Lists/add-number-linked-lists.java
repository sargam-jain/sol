...
class Solution {
    static Node addTwoLists(Node num1, Node num2) {
        // Reverse the input lists to handle numbers from least significant to most significant digit
        ...
        while (num1 != null || num2 != null || carry != 0) {
            ...
            current.next = new Node(sum % 10); // Create a new node with the remainder
